...
const openingStage = () =>
  stage('s1', 'פתיחת תיק', 'קבלת פרטי היבואן ופתיחת תיק במערכת', 1, 1, [
    ...
    task('הוקם תיק בדרייב והוזן קישור'),
  ]);
...
export const mockProjects: Project[] = [
  {
    ...
    documents: createDocuments(false),
  ...
  },
  {
    ...
    documents: createDocuments(true),
    chatHistory: createChatHistory(),
  ...
  },
  {
    ...
    quotedPrice: 6200,
    actualExpenses: 5800,
    driveLink: 'https://drive.google.com/example7',
    timeline: createTimeline('ייצור'),
    documents: createDocuments(true),
    chatHistory: createChatHistory(),
  ...
  },
  {
    ...
    quotedPrice: 4800,
    actualExpenses: 4200,
    driveLink: 'https://drive.google.com/example8',
    timeline: createTimeline('אישור'),
    documents: createDocuments(true),
    chatHistory: createChatHistory(),
